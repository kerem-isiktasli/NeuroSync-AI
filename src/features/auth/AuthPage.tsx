        ...
        <div className="relative rounded-2xl md:rounded-3xl bg-theme-surface-elevated border border-theme-border shadow-xl p-6 md:p-8 overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              type="button"
              className="flex items-center justify-center gap-2 bg-theme-surface hover:bg-theme-surface-elevated border border-theme-border text-theme-text-primary text-sm font-medium py-3 rounded-xl transition-colors duration-200"
            >
